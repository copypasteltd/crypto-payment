...
| 质量门 | 零警告 lint、TypeScript、生产构建、Admin API 烟测、全量 Backend smoke、4 条 Playwright Admin E2E、线上双主题双语言多视口回归 | 已完成 |
| 部署 | HZ01 原子版本目录、Nginx 独立端口 `38140`、同源 Admin API、`/healthz` 和回滚入口；当前版本 `20260715T071211Z` | 已完成 |
...
| 当前版本 | `20260715T071211Z` |
| 原子切换 | `/srv/lingban/current` 指向 `/srv/lingban/releases/20260715T071211Z` |
