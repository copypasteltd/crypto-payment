import { z } from "zod";
import { entrySurfaceSchema, connectorSourceSchema, connectorTransportSchema, credentialIdSchema, isoDatetimeSchema, mcpBindingIdSchema, mcpHealthSnapshotIdSchema, runIdSchema, sessionVersionIdSchema, taskVersionIdSchema, userIdSchema, workspaceIdSchema, } from "./common.js";
...
export const updateMcpInputSchema = z
    ...
    .refine((value) => Object.values(value).some((item) => item !== undefined), "At least one MCP field must be updated");
...
export const updateMcpBindingInputSchema = z
    ...
    .refine((value) => Object.values(value).some((item) => item !== undefined), "At least one MCP binding field must be updated");
...
export const updateMcpNetworkPolicyInputSchema = z
    ...
    .refine((value) => Object.values(value).some((item) => item !== undefined), "At least one MCP network policy field must be updated");
