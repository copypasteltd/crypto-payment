import { z } from "zod";
import { credentialIdSchema, credentialMountModeSchema, entrySurfaceSchema, isoDatetimeSchema, mcpBindingIdSchema, runIdSchema, sessionVersionIdSchema, taskVersionIdSchema, userIdSchema, workspaceIdSchema, } from "./common.js";
import { localizedTextSchema, serviceIdSchema, workshopIdSchema, workspaceContextKeySchema } from "./catalog.js";
import { mcpBindingScopeSchema, mcpBindingStatusSchema, mcpIdSchema, } from "./mcp.js";
...
export const updateCredentialInputSchema = z
    ...
    .refine((value) => Object.values(value).some((item) => item !== undefined), "At least one credential field must be updated");
...
export const credentialMaterializationLeaseSchema = z.object({
    ...
    requestedByUserId: userIdSchema.nullable().default(null),
    brokerKind: credentialBrokerKindSchema.nullable().default(null),
    brokerKindByCredentialId: z.record(z.string().min(1), credentialBrokerKindSchema),
